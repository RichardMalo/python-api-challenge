...
The following assignment has two parts. WeatherPy and Vacation Py and an output folder called output_data generated from WeatherPy code which is used later for VacationPy code.

It tries to anwser the following information:
